...
<head>  
  ...
  <body>
			...
			<div class="container">
			            ...
			            <div class="panel-heading">
			              <h4 class="panel-title">
			                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion-panel" href="#collapseOnePanel">
			                  Google Outh, Maps, Picassa, YouTube
			                </a>
			              </h4>
			            </div>
			            <!-- add "in" to end of class to expand -->
			            ...
			            <div class="panel-heading">
			              <h4 class="panel-title">
			                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion-panel" href="#collapseThreePanel">
			                  Zeus : Superstring, Graphics, Anime, REST 
			                </a>
			              </h4>
			            </div>
			      ...
			      <h4>Database Drivers</h4>
			        <div class="panel-group" id="accordion-panel2">
			          <div class="panel panel-danger">
			            ...
			            <div id="collapseOnePanel2" class="panel-collapse collapse">
			              <div class="panel-body">
			                Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. 
			              </div>
			            </div>
			  ...
			  <div align="center">
			        <a class="btn btn-default btn-large" href="<?php echo site_url('boesk/index') ?>"> <i class="fa fa-code fa-lg"></i> Zeusbase Web Layouts </a>
			  </div>
			
			  <div class="footer">
			    <p>&copy; Zeus Framework 2014</p>
			  </div>
